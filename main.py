...
# Load existing categories from file if it exists
if os.path.exists(category_file):
    try:
        with open(category_file, "r") as f:
            st.session_state.categories = json.load(f)
    except Exception:
        st.warning("Could not load categories file. Starting with default categories.")
...
def load_transactions(file):
    try:
        ...
        required_cols = {"Date", "Amount", "Details", "Debit/Credit"}
